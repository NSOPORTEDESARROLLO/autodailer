...
<div id="header">
	<div class="shell">
		<!-- Logo + Top Nav -->
		<div id="top">
			<h1><a href="#">Message Dialer</a></h1>
			<div id="top-navigation">
				Welcome <strong><?php echo $_SESSION[name];?></strong>
				<span>|</span>
				<a href="http://www.nsoporte.com">Help</a>
				<span>|</span>
...
<?php
	...
	//    $errors4 = '<span class="error">Select an Audio File</span>';
           ...
           $errors5 = '<span class="error">Please Insert a Trunk Name</span>';
		...
		$Tout=preg_replace("/ /",'_',$_POST['tout']);		
 		$Tbridge=preg_replace("/ /",'_',$_POST['tbr']);
		$Dest=preg_replace("/ /",'_',$_POST['dest']);
  ...
  PRIMARY KEY (`ID`)
		...
		$sql=mysql_query("SELECT ID FROM  Campaign WHERE CampaignName='$CampaignName'", $link) or die(mysql_error());
		    if (mysql_num_rows($sql) == 0)
       			{
				$sql1="INSERT INTO Campaign(CampaignName,LastIdDial,Tout,Dest) VALUES('$CampaignName','0','$Tout','$Dest')";
...
?>
					...
					<form  enctype='multipart/form-data' id="contact-form" action="" method="post">
						...
						<div class="form">
								...
								<p>
									<label>CSV File<span></span></label><?php echo $errors2 ?>
								 ...
								 <p>
                                                                        <label>Trunk<span></span></label><?php echo $errors5 ?>
                                                                        <input type=text class='field size1' name=tout id=tout value='<?php echo $_POST['tout']; ?>'>

                                                                </p>

                                                                     
								<p>
                                                                        <label>Destination<span></span></label><?php echo $errors6 ?>
                                                                        <input type=text class='field size1' name=dest id=dest value='<?php echo $_POST['dest']; ?>'>
...
<p align="center">&copy; <a href="http://www.nsoporte.com/" target="_blank">Nsoporte</a> 2020 / PBX: +506 40005242 / <a href="mailto:soporte@nsoporte.com">Contactar Soporte</a></a></p></a></p></body>
</html>
